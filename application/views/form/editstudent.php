    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="jenis_kelamin" name="jenis_kelamin" value="<?= $siswa['jenis_kelamin']; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="id_kelas" name="id_kelas" value="<?= $siswa['id_kelas']; ?>">
                        <option selected>-</option>
